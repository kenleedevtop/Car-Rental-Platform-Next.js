...
const OverviewPage = () => {
  ...
  const renderItemSecondaryMarket = ({ headItem }: TTableRenderItemObject) => {
    ...
    if (headItem.reference === 'actions') {
      return (
        <Button
          variant="contained"
          color={invest ? 'warning' : 'secondary'}
          onClick={handleInvest}
        >
          {invest ? 'Cancel' : 'Invest'}
        </Button>
      );
    }
  ...
  return (
    <OverviewMain>
          ...
          <OverviewGridOneTwo>
            ...
            <OverviewGridSecond>
              <HeadlineContainer>
                ...
                <OverviewTextSubHeadline>
                  Square Meters Owned <HighlightText>0.45</HighlightText>
                </OverviewTextSubHeadline>
              </HeadlineContainer>
              <Table
                head={DSecondaryMarketHead}
                items={[
                  {
                    capRate: '7%',
                    pricePerSqm: 'a',
                ...
                renderItem={renderItemSecondaryMarket}
              />
              {invest && (
                <OverviewGridTwo>
      ...
      {tab === 3 && (
        <Card>
          <Stack>
            <OverviewTextHeadline>Updates</OverviewTextHeadline>
            <Table
              head={DMarketHead}
              items={[
                {

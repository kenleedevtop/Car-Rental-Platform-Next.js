...
import { TScheduleInfluencerModalProps } from 'features/influencers/role/admin/elements/schedule-influencer-modal/types';
import { ScheduleInfluencerModalMain } from 'features/influencers/role/admin/elements/schedule-influencer-modal/styles';

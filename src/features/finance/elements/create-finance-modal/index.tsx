...
import { TCreateFinanceModalProps } from 'features/finance/elements/create-finance-modal/types';
import { CreateFinanceModalMain } from 'features/finance/elements/create-finance-modal/styles';

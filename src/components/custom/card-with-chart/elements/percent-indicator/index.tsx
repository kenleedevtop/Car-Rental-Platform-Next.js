...
import {
  PercentIndicatorMain,
  PercentIndicatorIcon,
  PercentIndicatorValue,
} from 'components/custom/card-with-chart/elements/percent-indicator/styles';
import { TPercentIndicatorProps } from 'components/custom/card-with-chart/elements/percent-indicator/types';

const PercentIndicator = ({ percent, ...props }: TPercentIndicatorProps) => (
  <PercentIndicatorMain percent={percent} {...props}>
    <PercentIndicatorIcon viewBox="0 0 6 5">
    ...
    <PercentIndicatorValue>{`${percent}%`}</PercentIndicatorValue>
  </PercentIndicatorMain>
);
